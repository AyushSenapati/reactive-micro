...
var fs = flag.NewFlagSet("inventorysvc", flag.ExitOnError)
...
func initEventHandler(logger *cl.CustomLogger, svc service.IInventoryService, nc *nats.EncodedConn, g *run.Group) {
